                ...
                <div class="col-lg-6 center">
                    <div class="card">
                        <div class="card-body card-block ">
                            <form:form action="/updateLesson" method="post" class="form-horizontal"
                                       modelAttribute="lesson">

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="ls_name"
                                                                     class=" form-control-label">Name</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="ls_name" name="nameLesson"
                                                                        placeholder="Enter lesson name..."
                                                                        class="form-control" value="${lesson.nameLesson}"></div>
                                    <div class="col col-md-3"><label for="tutorial"
                                                                     class=" form-control-label">Tutorial</label></div>
                                    <div class="col-12 col-md-9"><textarea name="tutorial" id="tutorial" rows="9"
                                                                           placeholder="Tutorial..."
                                                                           class="form-control">${lesson.tutorial}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="LS_id" name="id" hidden value="${id}" ></div>
                            </form:form>
                        </div>
