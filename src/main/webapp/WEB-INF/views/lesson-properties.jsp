                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Lesson Properties</strong>
                            ...
                            <a href="/admin/updateLsPage?id=${id}" ><button style="float: right" type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i>&nbsp; Update</button></a>
                            <a href="/del?id=${id}" onclick="return confirm('Bạn có muốn xóa không?')"><button style="float: right" type="button" class="btn btn-success btn-sm"><i class="fa fa-trash"></i>&nbsp; DELETE</button></a>
                        </div>
                        <div class="card-body">
                                <div class="left with">
                                    <b class="left"><label>Tên: &nbsp;</label></b>
                                    <p class="left">${lesson.nameLesson}</p>
                                </div>
                                <div class="left with">
                                    <b class="left"><label>Cơ sở dữ liệu: &nbsp;</label></b>
                                    <p class="left">${database.name}</p>
                                </div>
                                <div style="margin: auto">
                                    <b style="float: left"><label for="tutorial">Nội dung:&nbsp;</label></b>
                                    <div class="left">
                                        <p style="float: left" id="tutorial">${lesson.tutorial}</p>
                                    </div>
                                </div>
                        </div>
                    </div>
