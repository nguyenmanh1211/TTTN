                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <c:forEach items="${feedback}" var="item">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/feedbackProperties?id=${item.id}" class="fa fa-eye"></a>
                                            <a href="/deleteFeedback?id=${item.id}" class="fa fa-trash" onclick="return confirm('Bạn có muốn xóa không?')"></a>
                                        </td>
                                    </tr>
